...
public class Mybase extends baseclass implements ITestListener {

    ExtentTest Test;
    
    public static ExtentReports getExtentReport() {
        String reportPath = "C:\\Users\\boopa\\eclipse-workspace\\Project1\\reports";
    ...
    public void onTestStart(ITestResult result) {
        ...
        Test = report.createTest(testName).assignAuthor("Dhivi").assignCategory("AutomationTesting").assignDevice("Windows");
