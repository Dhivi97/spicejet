	 ...
	 public static WebDriver driver;
	    ...
	    public void launchBrowser(String browser) {
	        if (browser.equalsIgnoreCase("Chrome")) {
	        	  System.setProperty("webdriver.chrome.driver", "C:\\Users\\boopa\\Downloads\\chromedriver.exe");
	    ...
	    public static String takeScreenShot(String testCaseName) {
	        ...
	        File destinationFile = new File("C:\\Users\\boopa\\eclipse-workspace\\Project1\\Screenshots\\" + testCaseName + ".png");
	        try {
